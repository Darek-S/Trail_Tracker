...
public class GPSActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_report) {
            ...
            FragmentReport aboutDialog = new FragmentReport();
            aboutDialog.show(gm, "");
            return true;
        }
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new FragmentButton(), getResources().getString(R.string.record_trail));     ///////////Szabi edit
        adapter.addFragment(new FragmentGPSFix(), getResources().getString(R.string.gps_position));
        adapter.addFragment(new FragmentTrack(), getResources().getString(R.string.track_details));
        adapter.addFragment(new FragmentTracklist(), getResources().getString(R.string.history));
